...
class PseRequest extends FormRequest
{
    /**
    ...
    public function rules() : array
    {
        return [
            ...
            'transaction.extraParameters' => 'required|array',
            'transaction.extraParameters.RESPONSE_URL' => 'required|string',
            'transaction.extraParameters.PSE_REFERENCE1' => 'required|string',
            'transaction.extraParameters.FINANCIAL_INSTITUTION_CODE' => 'required|string',
            'transaction.extraParameters.USER_TYPE' => 'required|string',
            'transaction.extraParameters.PSE_REFERENCE2' => 'required|string',
            'transaction.extraParameters.PSE_REFERENCE3' => 'required|string',
