...
class RecurringPaymentRegistrationRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'transaction.creditCard.payerId' => 'required|string',
            'transaction.creditCard.identificationNumber' => 'required|string',
            'transaction.creditCard.paymentMethod' => 'required|string',
