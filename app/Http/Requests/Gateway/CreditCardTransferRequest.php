...
class CreditCardTransferRequest extends FormRequest
{
    /**
    ...
    public function rules() : array
    {
        return [
            ...
            'credit_card.security_code' => 'required|string',
            'credit_card.expiration_date' => 'required|string',
            'credit_card.name' => 'required|string',
            'credit_card.dues' => 'string',
            'ip' => 'required|string',
