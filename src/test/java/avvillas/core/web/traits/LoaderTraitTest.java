...
class LoaderTraitTest {
    ...
    void getProductById_returnsProductOnSuccess() {
        ...
        product.setId("p-1");
        ApiResponse<ProductDTO> body = ApiResponse.success(product, "ok", null);
    ...
    void getIndexFilePathByProductId_returnsPathOnSuccess() {
        ...
        ApiResponse<PathExtractsArchiveIndexDto> body = ApiResponse.success(dto, "ok", null);
    ...
    void getContentFileByProductId_returnsContentOnSuccess() {
        ...
        ApiResponse<ContentIndexFileDto> body = ApiResponse.success(dto, "ok", null);
