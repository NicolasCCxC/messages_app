...
import { createFile } from '@redux/input-file-upload/actions';
import { REQUIRED_FIELDS } from '@constants/Validation';

export const CreateFileUploadModal: React.FC<{
    toggleModal: () => void;
    toggleToast: () => void;
    ...
    const handleSave = async (): Promise<void> => {
        ...
        const response = await dispatch(createFile({ productId: product?.value, period: textValue }));
    ...
    return (
        <Modal open title="Cargar archivo fuente" onClose={toggleModal} onSave={handleSave}>
